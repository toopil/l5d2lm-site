...
Ouvrez l’l5d2lm-index.html dans un navigateur, ou lancez une simple commande de serveur local :
...
« À portée de main » fait partie de la page `l5d2lm-corps-expression.html`. Tant qu’aucune date n’est publiée, son bouton « Découvrir les prochaines dates » ouvre une demande de contact préremplie.
